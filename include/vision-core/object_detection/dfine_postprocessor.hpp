...
/**
 * @brief D-FINE postprocessing algorithms
 * 
 * Supports D-FINE (Define Fine-grained detection) models.
 * D-FINE is a DETR-based detector that refines bounding box regression.
 * 
 * Outputs:
 * - Boxes: [batch, num_queries, 4] (cx, cy, w, h)
 * - Scores: [batch, num_queries, num_classes]
 */
class DFinePostprocessor {
public:
    /**
     * @brief Process D-FINE output tensors
     * 

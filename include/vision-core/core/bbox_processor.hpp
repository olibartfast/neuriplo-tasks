...
class BBoxProcessor {
  public:
     ...
     */
    [[nodiscard]] static cv::Rect calculate_bounding_box(const cv::Size& image_size, const std::vector<float>& bbox,
     ...
     * @return Scaled bounding box in original image coordinates
     */
    [[nodiscard]] static cv::Rect calculate_bounding_box_from_xyxy(const cv::Size& image_size,
     ...
     */
    [[nodiscard]] static cv::Rect scale_to_original(const cv::Rect& bbox, const cv::Size& original_size,

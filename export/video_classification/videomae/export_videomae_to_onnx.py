...
def export_videomae_to_onnx(
    ...
    output_path="videomae.onnx",
    num_frames=16,
    image_size=224,
    opset_version=14,
    dynamic_batch=True
):
    """Export VideoMAE model to ONNX format."""
...
def test_onnx_model(onnx_path, num_frames=16, image_size=224):
...
def main():
    print("Starting VideoMAE ONNX export...")
    ...
    try:
        ...
        parser.add_argument("--output", default="videomae.onnx",
        ...
        onnx_path = export_videomae_to_onnx(

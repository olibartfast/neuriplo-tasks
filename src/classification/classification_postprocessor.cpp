...
std::vector<Classification> DefaultClassificationPostprocessor::postprocess(
...
float DefaultClassificationPostprocessor::getTensorFloat(const TensorElement& element) {

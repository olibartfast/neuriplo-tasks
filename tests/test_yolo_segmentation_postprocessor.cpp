...
TEST_F(YoloSegmentationPostprocessorTest, StandardOrder) {
    YoloSegmentationPostprocessor processor(
        InstanceSegmentationTask::ModelType::YOLO_SEG, 
        cv::Size(640, 640), 0.25f, 0.45f, 0.45f);
...
TEST_F(YoloSegmentationPostprocessorTest, NmsFreeSwappedOrder) {
     YoloSegmentationPostprocessor processor(
        InstanceSegmentationTask::ModelType::YOLO_V10_SEG, 
        cv::Size(640, 640), 0.25f, 0.45f, 0.5f);
